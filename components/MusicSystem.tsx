...
/* =========================================================
   REACTION BUTTON COMPONENT (from Feed.tsx)
========================================================= */
...
const ReactionButton: React.FC<{
  ...
  return (
    ...
    >
      {showDock && (
        <div className="absolute -top-16 left-0 bg-[#242526] rounded-full shadow-2xl p-2 border border-[#3E4042] z-50 flex items-center">
          <div className="flex gap-1 overflow-x-auto max-w-[320px] scrollbar-hide px-1 py-1">
            {reactionConfig.map((r) => (
              <div
                key={r.type}
                className="text-3xl cursor-pointer p-1 rounded-full hover:bg-[#3A3B3C] transition-colors flex-shrink-0"
                onClick={(e) => {
                  e.stopPropagation();
      ...
      >
        {activeReaction ? (
          ...
          <>
            <i className="fas fa-heart text-[22px] text-[#B0B3B8]"></i>
...
/* =========================================================
   MODERN GLOBAL AUDIO PLAYER (Boomplay Style with React/Discuss/Share)
========================================================= */
...
interface GlobalAudioPlayerProps {
  ...
  // New props for React/Discuss/Share
  reactionCount?: number;
  commentCount?: number;
  shareCount?: number;
      ...
      >
        {expanded ? (
          ...
          <div className="flex flex-col h-full w-full relative overflow-hidden bg-gradient-to-b from-gray-900 to-black">
            ...
            {/* REACT, DISCUSS, SHARE BUTTONS SECTION - NEW */}
            <div className="relative z-10 px-6 py-4 border-t border-white/10 bg-black/40">
              <div className="flex items-center justify-between max-w-md mx-auto">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 h-10 rounded hover:bg-white/10 transition-colors group"
                >
                  <DiscussSignalIcon size={28} color="#1877F2" />
                  <span className="text-[19px] font-bold text-[#B0B3B8] group-hover:text-white">
                ...
                <button
                  onClick={handleShare}
                  className="flex-1 flex items-center justify-center gap-2 h-10 rounded hover:bg-white/10 transition-colors group text-[#B0B3B8]"
                >
...
// The rest of the MusicSystem component remains the same...
// [Continue with the existing MusicSystem component code from your original file]
// Note: Due to length constraints, I've shown the key modifications to the GlobalAudioPlayer
// and added the CommentsSheet and ShareBottomSheet components.
/* =========================================================
   UPLOAD MODAL
========================================================= */
