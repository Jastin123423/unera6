  ...
  return (
    <>
      <div className="sticky top-0 z-50 bg-[#242526] shadow-sm h-14 flex items-center justify-between px-4 w-full border-b border-[#3E4042]">
        {/* ✅ Logo pulled ALL the way to the left corner with icon super close to text like "0UNERA" */}
        <div className="flex items-center justify-start min-w-[120px] pl-0">
...
const RightSidebar: React.FC<{ contacts: User[]; onProfileClick: (id: number) => void }> = ({
  contacts,
  onProfileClick,
}) => {
  return (
...
// Export all components at the bottom
export { MenuOverlay, Header, Sidebar, RightSidebar };
