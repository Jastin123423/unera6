...
{(isMusic || isPodcast) && (
  <div className="mx-3 md:mx-4 mb-3 rounded-2xl overflow-hidden relative">
    ...
    <div className="relative h-[200px] sm:h-[240px] w-full">
      <img
        src={isMusic ? (song?.cover_image_url || DEFAULT_MUSIC_COVER) : (podcast?.cover_url || DEFAULT_MUSIC_COVER)}
        className="absolute inset-0 w-full h-full object-cover"
        alt=""
        onError={(e) => {
      ...
      {/* Song info and Play button overlay */}
      <div className="absolute bottom-0 left-0 right-0 p-4 flex items-center gap-3">
        ...
        <button
          ...
          className="w-12 h-12 rounded-full bg-white text-black flex items-center justify-center flex-shrink-0 shadow-xl hover:scale-105 transition-transform"
        >
    ...
    <div className="bg-[#242526] px-2 py-1 flex items-center justify-between border-t border-white/10">
      ...
      <button
        className="flex-1 flex items-center justify-center gap-2 h-10 rounded hover:bg-[#3A3B3C] transition-colors group text-[#B0B3B8]"
        onClick={() => {
          if (!currentUser) { alert('Please login to share posts.'); return; }
