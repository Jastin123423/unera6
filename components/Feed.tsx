...
const MediaGrid = memo(
  ({ media, onOpen }: { media: { url: string }[]; onOpen: (url: string, index: number) => void }) => {
    ...
    // Add this ref for accessing media inside Tile
    ...
    // ========== UPDATED Tile component with SeamlessImage ==========
    const Tile = ({
      url,
      index,
      className,
      ...
      // For seamless images, we need 3 sizes. If we don't have them, use same URL for all
